...
상태: **구현 완료** (2026-08-22 작성·검수·구현. 검수 결정은 각 장과 아래
"검수 결정"에 반영. 검증 기록: `docs/verification/2026-08-22-t2-unix-display-paths.md`
· `2026-08-22-t1-banner-context-menu.md` · `2026-08-22-t4-accent-catalog.md` ·
`2026-08-22-t3-theme-resolution.md` · `2026-08-22-t3-appearance-settings-ui.md`)
...
2026-08-22 지시로 검수 방식이 바뀌었다: 체크포인트마다 멈추지 않고
`feature/theme-and-banner-menu` 브랜치에서 체크포인트당 커밋 하나로 진행한 뒤
한 번에 보고한다(사용자가 커밋을 체리픽하며 사후 검수). C1은 main에 먼저
커밋되었고 C2~C5가 브랜치에 있다.
