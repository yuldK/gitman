...
namespace gitman::ui {
    ...
    public:
        ...
        // 조건이다. `sort`는 정렬 전환 버튼의 현재 상태로, 클릭이 다음 기준을
        // 순환한다.
        toolbar_element(std::u8string document_text, bool show_open_button, bool generation_busy, bool relative_paths, bool document_open, card_sort_key sort);
